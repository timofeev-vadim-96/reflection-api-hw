...
public class Program {
    ...
    */
    public static void main(String[] args) throws IllegalAccessException, TableAnnotationNotFoundException {
        ...
        String deleteQuery = queryBuilder.buildDeleteQuery(Employee.class, primaryKey);
