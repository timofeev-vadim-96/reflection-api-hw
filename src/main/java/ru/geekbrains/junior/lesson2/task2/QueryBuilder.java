...
import ru.geekbrains.junior.lesson2.task2.customExceptions.TableAnnotationNotFoundException;
...
public class QueryBuilder {
    ...
    /**
     * Метод составления SQL-запроса на удаление по id
     */
    public String buildDeleteQuery(Class<?> clazz, UUID primaryKey) throws TableAnnotationNotFoundException {
        if (!clazz.isAnnotationPresent(Table.class)) {
        ...
        Arrays.stream(clazz.getDeclaredFields())
                ...
                .filter(field -> field.getAnnotation(Column.class).primaryKey()).findFirst().ifPresent(field -> {
